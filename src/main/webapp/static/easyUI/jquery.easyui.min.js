...
(function ($) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 31,
        headerEvents: {mouseover: _775(true), mouseout: _775(false), click: _779, dblclick: _77e, contextmenu: _781},
        rowEvents: {mouseover: _783(true), mouseout: _783(false), click: _78a, dblclick: _794, contextmenu: _798},
        ...
        loader: function (_936, _937, _938) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _936, dataType: "json", success: function (data) {
                    _937(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _afd, keydown: _b01, paste: _b01, drop: _b01, blur: _b04},
        panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        loader: function (_b92, _b93, _b94) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _b92, dataType: "json", success: function (data) {
                    _b93(data);
                }, error: function () {
...
(function ($) {
    function _c3d(_c3e) {
        ...
        $(_c3e).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_c40, _c41) {
                _c42();
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 250, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_c9c) {
                ...
                $(_c9d).datebox("calendar").calendar({
                    year: _c9e.getFullYear(),
                    month: _c9e.getMonth() + 1,
                    current: _c9e
                });
...
(function ($) {
    function _ca2(_ca3) {
        ...
        $(_ca3).datebox("calendar").calendar({
            onSelect: function (date) {
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _cb8.originalValue,
                disabled: _cb8.disabled,
                readonly: _cb8.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
...
(function ($) {
    function _cc5(_cc6) {
        ...
        $(_cc6).addClass("timepicker-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _cc8(this);
                _cc9(_cc6);
    ...
    $.fn.timepicker.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "timepicker").options, {
                width: _cf9.width,
                height: _cf9.height,
                originalValue: _cf9.originalValue,
                disabled: _cf9.disabled,
                readonly: _cf9.readonly
            });
...
(function ($) {
    ...
    function _d11(_d12) {
        ...
        _d14.find("a.slider-handle").draggable({
    ...
    $.fn.slider = function (_d33, _d34) {
        ...
        return this.each(function () {
            ...
            if (_d35) {
                ...
                _d35 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _d33),
                    slider: init(this)
                });
                $(this)._propAttr("disabled", false);
            }
    ...
    $.fn.slider.parseOptions = function (_d39) {
        var t = $(_d39);
        return $.extend({}, $.parser.parseOptions(_d39, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_d3a) {
            return _d3a;
        },
        converter: {
            toPosition: function (_d3b, size) {
                var opts = $(this).slider("options");
